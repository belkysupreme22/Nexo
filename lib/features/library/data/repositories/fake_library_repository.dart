...
class FakeLibraryRepository implements LibraryRepository {
  ...
  final MediaSource _deviceSource = const MediaSource(
    id: 'device-primary',
    type: MediaSourceType.device,
    label: 'Device',
  );

  late final List<Song> seedSongs = [
    Song(
      id: 'starboy',
      title: 'Starboy',
  ...
  late final List<ArtistSummary> _artists = const [
    ArtistSummary(
      id: 'ariana-grande',
      name: 'Ariana Grande',
      albumCount: 1,
  ...
  late final List<AlbumSummary> _albums = const [
    AlbumSummary(
      id: 'dawn-fm',
      title: 'Dawn FM',
      artist: 'The Weeknd',
  ...
  late final List<FolderSummary> _folders = const [
